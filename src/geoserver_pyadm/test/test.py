...
geoserver.upload_shapefile(ws_name, store_name_1, f"{script_path}/coastlines_0Ma.zip")
geoserver.upload_shapefile(ws_name, store_name_1, f"{script_path}/coastlines_230Ma.zip")
